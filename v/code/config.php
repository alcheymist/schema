...
class config{
    ...
    //
    // The database and entity to manage the user and application currently running.
    ...
    // 
    // SVGtest data
    public string $svg = "/ranics/v/code/flow.html";
    // 
    ...
    public int $limit = 40;
    //
    //The application path, i.e., ../code, set from the constructor;
    public string $path;
    //
