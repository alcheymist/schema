...
type z<x extends new (...args:any)=>any> = ConstructorParameters<x>;
//
...
export async function exec<
    ...
    //
    //Get the actual class that is indexed by the class name
    $class_temp extends classes[class_name],
    //
    //Unable to express class_temp in terms of  'new (...args: any) =>any'. Hence
    //the 4 errors below
    $class extends $class_temp,
    //
    //I tried this...and failed. It means that $class_temp does not extend the 
    //constructor type. So, how is $class_temp related to a a constructor?
    //$class extends Extract<$class_temp, {new (...args: any):any}>,
    //
    //I also tried....and failed too
    //$class extends Extract<$class_temp[keyof $class_temp], new (...args: any) =>any>,
    // 
    ...
    // 
    //Get the aacutal, i.e.., indexed method
