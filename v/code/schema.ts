...
class database extends schema{
    //
    //A collection of entites for this database modeled into a map because with 
...
class entity extends schema{
    ...
    //
    //This is the string representation of an entity designed to help us with our
    //sql work.
    get str():string{
        //
        return;
...
class column extends schema{
    ...
    constructor(public entity:entity, static_column:any){
        ...
        super(`${entity.dbase.name}.${entity.name}.${static_column.name}`);
        //
    ...
    //
    //This is the string reprensentation of a column designed to support the sql
    //work.
    get str():string{
        //
        ...
        //
        //Compile the full name in backitck enclosed and dot separated.
...
//
//The subject as an object opposed to the array.
