...
class server{
    ...
    const LOCALHOST= [
        'url'=> 'http://localhost/schema/v/code/index.php',
        'username'=>'root',
        'password' => ''
    ];    
    //
    ...
    function migrate(object /*{dbname, server}*/ $from):true|string /*as error*/{
        //
        ...
        //
        //Use the sqls to extract data from remote and transmit it teh current one
...
class extractor{
    ...
    function get_data($sql/*{tname:string, sql:string}*/, \PDO $pdo):array /*<{tname, matrix, columns}>*/{
        ...
        //
        //Use the PDO statement to get the column metadata.and Map the metadata to columns, i.e., ename/cname pairs
        $columns = $stmt->self::get_column_meta_data($stmt);
        //
    ...
    function get_column_meta_data(\PDOStatement $stmt):array /*<{ename:string, cname: string}>*/ {
        ...
        //
        return $result; /*Array<{tname, cname}*/
    }
...
class ingester{
    ...
    //The data to be ingested, i.e., teh ingestee. Its structure is explained below
    public array $data/*<{tname, ccolumns, matrix}>*/;
    
    
   function __construct(array/*<{tname, columns, matrix}>*/ $data){
       $this->data = $data;
   }
   
   //Execute use the ingester data to effect the kingestion process
   function execute():true|string /*as error*/{
       //
    ...
    function get_labels(string $tname,array /*<subject ={ename, cname}>*/ $columns): \Generator {
        //
        //Get teh database name to save the data to
        $dbname = $this->dbname;
        //
